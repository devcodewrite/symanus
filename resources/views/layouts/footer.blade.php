<footer class="mt-5 w-full py-5 px-4 mx-auto bg-white lg:pl-72">
    <!-- Grid -->
    <div class="text-center flex flex-column items-center justify-between">
        <p class="text-gray-500">Copyright © Codewrite Technology Ltd 2022 SYMANUS. All rights reserved.</p>
        <!-- Social Brands -->
        <div class="space-x-2">
