@props(['class' => 'flex-shrink-0 mr-3 overflow-visible h-3.5 w-3.5 text-gray-100 dark:text-gray-400'])

<svg class="{{$class}} " fill="currentColor" height="800px" width="800px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
