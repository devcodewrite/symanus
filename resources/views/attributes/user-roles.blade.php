    ...
    <div class="w-full px-4 sm:px-6 md:px-8 lg:pl-72 py-5">
        <div class="class-details flex flex-col bg-white py-5">
            <div class="w-full" aria-label="body">
                        ...
                        <div
                            ...
                            <div class="flex">
                                ...
                                @if (isset($userRole))
                                    ...
                                    <x-a-button href="{{ route('user-roles.index') }}" class="ml-3 py-3.5 shadow-md">
                                        {{ __('Cancel') }}
                                    </x-a-button>
                                @else
                                    <x-button-p class="ml-3 py-3.5 shadow-md ">
                                ...
                                @foreach ($userRoles as $key => $row)
                                    <tr>
                                        ...
                                        <td class="border text-center flex items-end gap-3">
                                            <form action="{{ route('user-roles.update', ['user_role' => $row->id]) }}"
                ...
                <div class="divide-y divide-slate-300 hidden" id="basic-tabs-2" role="tabpanel"
