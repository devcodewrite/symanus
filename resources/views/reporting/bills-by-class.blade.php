<x-app-layout>
    ...
    @section('breadcrumb')
        <x-breadcrumb :items="[
            ['title' => 'Reporting', 'url' => route('reporting.bills-by-class')],
            ['title' => 'Bills by Class', 'url' => route('reporting.bills-by-class')],
        ]" />
    @endsection
    <!-- Content -->
            ...
            <div class="w-full" aria-label="body">
                ...
                <div class="mt-3 p-5">
                    <div class="divide-y divide-slate-300 flex flex-col gap-8" id="basic-tabs-1" role="tabpanel"
                        ...
                        <form class="flex flex-col gap-5" action="{{ route('reporting.bills-by-class') }}"
                            method="GET">
                            <div class="flex flex-row gap-5">
                                <span class="text-gray-400">Reporting name </span>
                                <span class="">Bills by Class Report</span>
                            </div>
    ...
    <!-- End Content -->
    @section('script')
        <script src="{{ asset('js/reporting/bills-by-class.js') }} " defer></script>
    @endsection
