<x-app-layout>
    ...
    @section('breadcrumb')
        <x-breadcrumb :items="[
            ['title' => 'Reporting', 'url' => route('reporting.expense-summary')],
            ['title' => 'Expense Summary', 'url' => route('reporting.expense-summary')],
        ]" />
    @endsection
    <!-- Content -->
            ...
            <div class="w-full" aria-label="body">
                ...
                <div class="mt-3 p-5">
                    <div class="divide-y divide-slate-300 flex flex-col gap-8" id="basic-tabs-1" role="tabpanel"
                        ...
                        <form class="flex flex-col gap-5" action="{{ route('reporting.expense-summary') }}"
                            method="GET">
                            <div class="flex flex-row gap-5">
                                <span class="text-gray-400">Reporting name </span>
                                <span class="">Expense Summary Report</span>
                            </div>
                        ...
                        <main class="p-5">
                            <table class="dt-report-expense-summary display w-full"
                            data-title="{{ isset($reportFrom)?Str::of("Expense Reporting for Users")->headline():'' }}"
    ...
    <!-- End Content -->
    @section('script')
        <script src="{{ asset('js/reporting/expense-summary.js') }} " defer></script>
    @endsection
