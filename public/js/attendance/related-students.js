var studentTable = $(".dt-related-students").DataTable({
    ...
    buttons: [
        ...
        },
        {
            ...
            footer: true,
            title:
                $(".dt-related-students").data("title") +
                "\n" +
    ...
    ajax: {
        ...
        data: function (param) {
            ...
            param.attendance_id = $(".dt-related-students").data(
                "attendance-id"
            );
        },
    },
    ...
    initComplete: function (settings) {
        $(".dt-related-students.dataTables_wrapper table").wrap(
            ...
            render: function (data, type, row) {
                if (type === "display") {
                    ...
                    let d =
                        ...
                        icon +
                        '<span class="underline">Class</span></p>' +
                        "<p><b>Student Ref: </b>" +
                        data.studentid +
                        "</p>" +
                        "<p><b>Student Name: </b>" +
        ...
        },
        {
            ...
            render: function (data, type, row) {
                if (type === "display" && data) {
                    let d =
                        '<div class="hs-tooltip inline-block [--trigger:hover] [--placement:right]">' +
                        '<a class="hs-tooltip-toggle inline text-left" href="../guardians/' +
                        data.id +
                        '">' +
        ...
        },
        {
            ...
            render: function (data, type, row) {
                if (type === "display") {
                    ...
                    return `<span class="p-1 px-2 text-white rounded ${
                        labels[data]
