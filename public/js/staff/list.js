var staffTable = $('.dt-staffs').DataTable({
    dom: 'PlBftip',
    buttons:[
        {
            text: 'Reload',
        ...
        },
        {
            extend: 'excel',
            footer: true,
            title: $('.dt-staffs').data('title')+"\n"+$('.dt-staffs').data('subtitle'),
    ...
    },
    {
        ...
        { 
            ...
            render:function(data, type, row){
                if(type === 'display'){
                return `<div class="flex gap-3 items-center"><a href="staffs/${data}" class="text-gray-600 hover:text-sky-600"><i class="fa fa-eye"></i></a>
                        <a href="staffs/${data}/edit" class="text-gray-600 hover:text-sky-600"><i class="fa fa-edit"></i></a></div>`;
                }
                return data;
            }
        }
...
$('.dt-staffs').removeClass('hidden');

dtRowSelectAction(staffTable);