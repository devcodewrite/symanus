var attendanceTable = $(".dt-related-attendances").DataTable({
    dom: "PlBftip",
    buttons: [
        {
            text: "Reload",
    ...
    ajax: {
        url: "/api/datatables/staff-related-attendances",
        dataType: "json",
...
$(".dt-related-attendances").removeClass("hidden");

dtRowSelectAction(attendanceTable);
